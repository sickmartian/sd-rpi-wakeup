...
This guide enables your 1st gen Steam Deck (SD) placed in a Steam Docking Station (SDS) to wake up remotely, using a Raspberry Pi (RPi) with OTG capabilities to simulate a keyboard press. Here I'm providing an overview of the process and [an image](https://github.com/sickmartian/sd-rpi-wakeup/releases) to use on the RPi plus links to guides and sources I used to put this together.

This repository is open to contributions with alternative steps, troubleshooting information and specially differences that might apply yo a RPi 4, which I don't have, so I couldn't test.

My SD sits far from me inside a cabinet, and it's used as a media center so turning it on an off happens all the time. 2nd+ gen Steam Decks support waking the device but gen 1 never got the ability, unless you happen to have a special dock or a Steam Controller. While I got a hold of a Steam Controller the fact that it uses batteries you have to buy or recharge is very annoying.

## Demo



https://github.com/sickmartian/sd-rpi-wakeup/assets/492246/afa2b46a-221f-4af0-8356-96a59ace589d
...
- PC - Powerful enough to run docker and compile the linux kernel, I'm using a MacBook Pro with Apple Silicon
...
- [open ssh](https://www.openssh.com/) - usually preinstalled
- [git](https://git-scm.com/) - usually preinstalled
- [rpi-imager](https://www.raspberrypi.com/software/)
- [pre-prepared image](https://github.com/sickmartian/sd-rpi-wakeup/releases) - get the latest from the releases section
...
There is a [pre-prepared image](https://github.com/sickmartian/sd-rpi-wakeup/releases) with these steps performed, it requires you to download a big file and putting it directly into your RPi as an OS.
...
Only if you are not using the [pre-prepared image](https://github.com/sickmartian/sd-rpi-wakeup/releases), you should perform the following steps, there is no handholding here, no mention on how to edit files, go to root, etc, if you need this I assume you have some linux experience already.
